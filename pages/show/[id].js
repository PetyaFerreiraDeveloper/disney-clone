...
function Show({ result }) {
  ...
  let seasons = result.seasons.length;
  let displayText = '';
  if (seasons === 1) {
    displayText = `${seasons} season`
  } else {
      displayText = `${seasons} seasons`
  }
    ...
    <div>
      ...
      {session ? (
        ...
        <section className="relative z-50">
          ...
          <div className="absolute inset-y-auto bottom-0 space-y-6 z-50 bg-black/30 text-[f9f9f9] p-6">
            ...
            <div className="flex items-center space-x-3 md:space-x-5">
              ...
              >
                <img className="h-6 md:h-8" src="/images/play-icon-white.svg" alt="" />
        ...
        {/* Background Overlay for the trailer */}
...
export async function getServerSideProps(context) {
  ...
  const request = await fetch(
    `https://api.themoviedb.org/3/tv/${id}?api_key=${process.env.API_KEY}&language=dk&append_to_response=videos`
