...
// this returns the show icon on the main page with all of its styling
function ShowThumbnail( {result} ) {
    const BASE_URL = "https://image.tmdb.org/t/p/original/";
    const router = useRouter();

    return (
        // when the show thumbnail is clicked it will lead to a show page, here we use the router functionality
